...
export const NavigationBar = () => {
  return <nav className="fixed top-0 left-0 right-0 z-10 flex items-center justify-between py-4 px-6 sm:px-10 backdrop-blur-lg bg-black/20 dark:bg-black/20 border-b border-purple-200/30 dark:border-white/5">
